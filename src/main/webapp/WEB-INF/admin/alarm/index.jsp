				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
							...
							<button type="button" class="btn btn-danger btn-lg">
								<span class="glyphicon glyphicon-trash" aria-hidden="true"></span>短信通知
							</button>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="exampleInputEmail1" class="col-md-4 text-right">到期日期</label>
									<div class="col-md-6">
