...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			<li
				<c:if test="${fn:contains(currentUrl, 'dashborad')||fn:contains(currentUrl, 'leaveMessages')}">class="active"</c:if>>
				<a href="<%=baseUrl%>/admin/dashborad"> <i class="fa fa-bars"
			...
			<shiro:hasRole name="admin">
				...
				<li
					...
					<a href="<%=baseUrl%>/admin/users"> <i class="fa fa-users"
