					...
					<div class="box-body">
						<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="exampleInputEmail1" class="col-md-4 text-right">单位</label>
										<div class="col-md-8">
											<input type="text" class="form-control" name="dispatcher"
												value="${distribution.dispatcher}" placeholder="单位">
										</div>
									</div>
								</div>
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<div class="col-md-8">
											<input type="text" class="form-control" name="dispatcher"
												value="${distribution.dispatcher}" placeholder="库区">
										</div>
									</div>
								</div>
