  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<%=baseUrl%>/admin/newsCategories/${news.navmenueId}/news">列表</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <c:import url="_form.jsp">
                <c:param name="actionUrl" value="${pageContext.request.contextPath}/admin/newsCategories/${news.navmenueId}/news/${news.id}/update"></c:param>
