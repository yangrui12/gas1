									...
									<c:forEach var="newItem" items="${pages.list}">
										<tr>
											...
											<td><a class="btn btn-default"
												href="${pageContext.request.contextPath}/admin/newsCategories/${newItem.navmenueId}/news/${newItem.id}/edit">编辑</a>
												<form
													action="${pageContext.request.contextPath}/admin/newsCategories/${newItem.navmenueId}/news/${newItem.id}"
							...
							<div class="col-md-12">
								<c:import url="../shared/_page.jsp">
									<c:param name="pageUrl"
										value="${pageContext.request.contextPath}/admin/newsCategories/${newsCategory.id}/news"></c:param>
								</c:import>
							</div>
						</div>
					</div>
